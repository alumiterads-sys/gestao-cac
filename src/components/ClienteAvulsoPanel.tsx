...
export const ClienteAvulsoPanel: React.FC<ClienteAvulsoPanelProps> = ({ cliente, onClose, onUpdated }) => {
    ...
    const handleAddGuia = async (e: React.FormEvent) => {
        ...
        if (ok) { showMessage('Guia adicionada!', 'success'); setShowAddGuia(false); setGtNumero(''); setGtEmissao(''); setGtVencimento(''); setGtOrigem(''); setGtDestino(''); loadData(); }
        else showMessage('Erro ao adicionar guia.', 'error');
        setIsLoading(false);
    };
                ...
                <div className="p-6 flex flex-col gap-4">
                    ...
                    {activeTab === 'armas' && (
                        <div className="flex flex-col gap-4 animate-fade-in">
                            ...
                            {isLoading ? <div className="flex justify-center p-8"><span className="loading-spinner"></span></div> :
                                crafs.length === 0 ? (
